...
const Exchange = function(config, session, tradeStore) {
    ...
    return {
        ...
        backfill({ lastId, since, mode = 'TRADE' } = {}) {
            ...
            if (mode === 'TRADE' && !lastId) {
                ...
                if (since) {
                    fromDate = this.formatDate(since);;   // Will use to determine when to stop backfilling.
                } else {
