...
// Global Modules
const allIndicators = require('./calculations/allIndicators');
...
modules.singleton('allIndicators', allIndicators, ['session', 'tradeStore']);
modules.singleton('BackfillService', BackfillService, ['config', 'exchange', 'processArgs', 'session', 'taskManager']);
modules.singleton('db', db, ['config', 'session', 'taskManager', 'tradeStore']);
modules.singleton('engine', engine, ['session', 'taskManager']);
modules.singleton('exchange', exchange, ['config', 'db', 'session', 'tradeStore']);
...
modules.singleton('taskManager', taskManager, ['allIndicators', 'config', 'executeOrder', 'session', 'tickerDetails', 'tradeStore']);
